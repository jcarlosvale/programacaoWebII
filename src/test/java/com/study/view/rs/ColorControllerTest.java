...
class ColorControllerTest {
    ...
    @Autowired
    private Map<Integer, ColorDTO> repository;
    ...
    void setup() {
        ...
        repository.put(1, ColorDTO.builder().id(1).description("Verde").build());
        repository.put(2, ColorDTO.builder().id(2).description("Amarelo").build());
        repository.put(3, ColorDTO.builder().id(3).description("Azul").build());
        repository.put(4, ColorDTO.builder().id(4).description("Vermelho").build());
    }
    ...
    void getAll() {
        ...
        //WHEN
        var response = restTemplate.getForEntity(URL, ColorDTO[].class);
    ...
    void getByPrefix(final String prefix, final int counter) {
        ...
        //WHEN
        var response = restTemplate.getForEntity(URL, ColorDTO[].class, prefix);
    ...
    void getById() {
        ...
        //WHEN
        var response = restTemplate.getForEntity(URL+ "/{id}", ColorDTO.class, id);
    ...
    void getById_NotFound() {
        ...
        //WHEN
        var response = restTemplate.getForEntity(URL+ "/{id}", ColorDTO.class, 999);
    ...
    void save() {
        ...
        //WHEN
        var response = restTemplate.postForEntity(URL, newDto, ColorDTO.class);
    ...
    void save_Exists() {
        ...
        //WHEN
        var response = restTemplate.postForEntity(URL, dto, ColorDTO.class);
    ...
    void update_NotFound() {
        //GIVEN
        var request = ColorDTO.builder().build();
        var initialCounter = repository.size();

        //WHEN
        var response = restTemplate.exchange(URL+"/{id}", HttpMethod.PUT,
                new HttpEntity<>(request), ColorDTO.class, 999);
