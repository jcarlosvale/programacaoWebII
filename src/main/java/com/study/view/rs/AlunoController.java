...
public class AlunoController {
    ...
    private final Map<Long, AlunoDto> repository;
    ...
    @GetMapping(path = "/{id}")
    public ResponseEntity<AlunoDto> getById(@PathVariable("id") final Long id) {
    ...
    @PostMapping
    public ResponseEntity<AlunoDto> save(@RequestBody @Validated final AlunoDto aluno) {
    ...
    @PutMapping(path = "/{id}")
    public ResponseEntity<AlunoDto> update(@PathVariable("id") final Long id, @RequestBody @Validated final AlunoDto aluno) {
